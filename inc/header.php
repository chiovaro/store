...
<body>
	...
	<div class="header">
		...
		<div class="wrapper">
			...
			<h1 class="branding-title"><a href="<?php echo BASE_URL; ?>">Shirts 4 Zach</a></h1>
			...
			<ul class="nav">
				...
				<li class="cart"><a target="paypal" href="https://www.paypal.com/cgi-bin/webscr?cmd=_cart&amp;business=329T3C63G6AHA&amp;display=1">Shopping Cart</a></li>
			</ul>
